    ...
    <div>
      ...
      <div id="parentDiv">
        ...
        <div className="post">
          ...
          <a
            className="demo"
            href="https://s3.amazonaws.com/jbrowse.org/code/jb2/alpha/itcr_demo_linear_comparative/index.html?config=test_data/config_longread.json"
          >
            Demo (dotplot read vs ref)
          </a>
          <a
            className="demo"
            href="https://s3.amazonaws.com/jbrowse.org/code/jb2/alpha/itcr_demo_linear_comparative/index.html?config=test_data/config_longread_linear.json"
          >
        ...
        <div className="post">
          ...
          <p>
            A GDC demo with track downloading from the GDC GraphQL API,
            displaying variants that are colored by the VEP effect score.
          </p>
          <a
            className="demo"
            href="https://s3.amazonaws.com/jbrowse.org/code/jb2/alpha/itcr_demo_gdc/index.html?config=test_data/config_longread.json"
          >
            Demo (dotplot read vs ref)
          </a>
        </div>
